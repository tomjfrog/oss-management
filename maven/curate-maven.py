...
def main():
    ...
    tmp_pomxml_str = base64.b64decode(b'tmp_pomxml_base64')
    ...
    # Make http/curl requests to artifactory to curate each jar file.  This process bring each dependency into a remote.
    tmp_jar_failures = []
    tmp_jar_successes = []
    ...
    # Copy successfully pulled artifacts to the local (approved-oss) repo.
    tmp_copy_successes = []
    tmp_copy_failures = []
